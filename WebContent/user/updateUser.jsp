	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="phone1" class="ct_input_g" style="width:50px" 
				...
				<option value="010" ${ ! empty userVO.phone1 && userVO.phone1 == "010" ? "selected" : ""  }>010</option>
				<option value="011" ${ ! empty userVO.phone1 && userVO.phone1 == "011" ? "selected" : ""  }>011</option>
				<option value="016" ${ ! empty userVO.phone1 && userVO.phone1 == "016" ? "selected" : ""  }>016</option>
				<option value="018" ${ ! empty userVO.phone1 && userVO.phone1 == "018" ? "selected" : ""  }>018</option>
				<option value="019" ${ ! empty userVO.phone1 && userVO.phone1 == "019" ? "selected" : ""  }>019</option>
			</select>
			<input type="text" name="phone2"
						<%--if (vo.getPhone() != null) {--%> 
						value="${ ! empty userVO.phone2 ? userVO.phone2 : ''}"
						<%-- }--%> 
						class="ct_input_g" style="width:100px; height:19px"  maxLength="9" >
			- 
			<input type="text" name="phone3" 
						<%--if (vo.getPhone() != null) {--%>
						value="${ ! empty userVO.phone3 ? userVO.phone3 : ''}"
						<%--} --%> 
						class="ct_input_g" style="width:100px; height:19px"  maxLength="9" >
